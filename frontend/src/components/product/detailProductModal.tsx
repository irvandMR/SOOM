...
export default function DetailProductModal({ visible, onHide, product, recipes, loading, onRecipeModal }: Props) {
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
              ...
              <Button
                ...
                variant="ghost"
                size="small"
                onClick={() => { onHide(); navigate(`/products/${product.id}/recipes`) }}
              />
            </div>
            ...
            {loading ? (
              ...
              <div style={{ fontSize: 12, color: 'var(--muted)', textAlign: 'center', padding: '12px 0' }}>
                ...
                <span onClick={onRecipeModal} style={{ color: 'var(--accent)', cursor: 'pointer' }}>
                  Tambah resep
                </span>
              </div>
            ) : (
